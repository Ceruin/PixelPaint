...
export class App {
  constructor(canvas) {
    ...
    this.opts = {
      ...
      symmetry: 'none', radial: 6, wrap: false, grid: false, gridSize: 16, pixelGrid: true, pixelSize: 1, pixelPerfect: true, pixelErase: false, pixelShape: 'line', pixelFill: false, onion: false, onionPrev: 1, onionNext: 1, onionAlpha: 0.5, playDir: 'forward', snapAssist: false, showAssist: true, assistKind: 'ruler',
