...
const SECTIONS = [
  ...
  ['pixel', 'Pixel art', ['File ▸ New Canvas has pixel presets: small canvases stay crisp and fit at whole zooms. Use the Pixel Pencil (P) and Pixel Line & Shapes (Shift+P); right-click erases. Export crisp enlargements and sprite sheets from File, or open the canvas in Sprite Studio for tiles, voxels and .aseprite.']],
